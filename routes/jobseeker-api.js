...
const {createStudent, getAllStudents, getStudentById, updateStudent, deleteStudent, loginStudent} = require("../student/controller");
...
// add a new student to database
endpoint.post('/login-student', userValidator.validate("loginStudent"), loginStudent);
